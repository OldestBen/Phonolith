...
import { Waves, Music, BarChart3, Cpu, Shield, Settings, SearchCode, GitCompare, Mic2, Trash2, ListMusic, Network } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/polyphony',  label: 'Polyphony',  icon: Network,     end: false },
